...
* _Automating VMs with Ansible Automation Platform_: In this section we will see how Red Hat Ansible Automation Platform and OpenShift Virtualization work together, by dynamically discovering a virtual machine and running a pre-built playbook against it to demonstrate automated patch management.
