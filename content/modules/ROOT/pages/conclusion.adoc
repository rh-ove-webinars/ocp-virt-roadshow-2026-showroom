...
Everything you experienced in this lab ran on *Intel Xeon processors* — the same hardware powering enterprise data centers worldwide.

image::intel-logo.svg[Intel,100,link=self]
...
* OpenShift Virtualization on Intel Xeon delivers proven performance for enterprise VM workloads — migration, management, and modernization on hardware you trust.
