...
* https://infohub.delltechnologies.com/sv-se/l/dell-powerprotect-data-manager-protecting-openshift-workloads/powerprotect-data-manager-protection-of-openshift-virtualization-vms/[*Dell PowerProtect Data Manager*^]
